  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1">
      ...
      <div className="mt-auto border-t border-gray-100 bg-gray-50/50 p-4">
        ...
        <button
          onClick={onEdit}
          className="w-full flex items-center justify-center gap-2 rounded-lg bg-white border border-gray-300 px-3 py-2 text-xs font-bold text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:text-blue-600 hover:border-blue-200 active:scale-[0.98]"
        >
